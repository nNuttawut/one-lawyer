...
import CreateScanNotice from "./modal/CreateScanNotic";
import { optionsLocat } from "../../../utils/constant/LocatOption";

const Main = () => {
  const [convertDateThai] = DateCustom();
  const [isModal, setIsModal] = useState(false);
  const [isModalCreateScan, setIsModalCreateScan] = useState(false);
  ...
  return (
    <>
      ...
      {isModalCreateScan ? (
        <CreateScanNotice
          open={isModalCreateScan}
          close={setIsModalCreateScan}
...
const CreateScanNoticeMain = MotionHoc(Main);
export default CreateScanNoticeMain;
