  ...
  const formDataSet = () => {
    return (
      ...
      >
        ...
        {buttonCalFounds ? (
          <>
            <Form.Item label="วันเริ่มทำสัญญา" name="balance"></Form.Item>
            ...
            <Form.Item label="ต้นคงเหลือ" name="principle"></Form.Item>
            <Form.Item label="วันที่คิดดอกเบี้ย" name="principle"></Form.Item>
            <Form.Item label="จำนวนงวด" name="principle"></Form.Item>
            <Form.Item label="งวดละ" name="principle"></Form.Item>
            <Form.Item label="ค้างดอกเบี้ย" name="principle"></Form.Item>
            ...
            <Form.Item label="ดอกเบี้ย" name="balance"></Form.Item>
