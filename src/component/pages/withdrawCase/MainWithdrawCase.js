...
import { WITHDRAW_CASE } from "../../../utils/constant/StatusConstant";
  ...
  const loadData = async (data) => {
    ...
    try {
      const response = await axios.get(
        baseUrl + GET_JOB_IN_PROGRESS_BY_STATUS + WITHDRAW_CASE,
        {
...
const MainWithdrawCase = MotionHoc(Main);
export default MainWithdrawCase;
